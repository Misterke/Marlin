...
#define STRING_CONFIG_H_AUTHOR "(mrk, Ender-3-Pro-Mini-E3-V2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro E3v2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // Creality Ender-3 Original Hotend
    //#define DEFAULT_Kp 22.62
    //#define DEFAULT_Ki 2.00
    //#define DEFAULT_Kd 63.93

    // Creality Ender-3 Micro Swiss All-Metal Hotend
    #define DEFAULT_Kp 31.60
    #define DEFAULT_Ki 3.28
    #define DEFAULT_Kd 75.99
  #endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 139.38
  #define DEFAULT_bedKi 23.82
  #define DEFAULT_bedKd 543.77
...
#define Z_PROBE_FEEDRATE_FAST (3 * (4 * 60))
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 43, 30, 43, 30 } // (mm) Left, Front, Right, Back insets
